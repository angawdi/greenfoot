public class CircleSolidClient {
	...
	public static void main(String[] args) {
		...
		// assign subclass object reference (Cylinder) to a superclass object reference (Circle)
		// then output the superclass object reference
		circleV1 = cylinder1;
		System.out.println(circleV1.toString()+"\n");

		// assign subclass object reference (Sphere) to a superclass object reference (Circle)
		// then output the superclass object reference
		circleV1 = sphere1;
		System.out.println(circleV1.toString()+"\n");

		// create an array of 3 Circle objects, assign a new Circle to one position,
		// a new Cylinder to the second position, and a new Sphere to the third position
		// then use a loop to output the objects in the array
